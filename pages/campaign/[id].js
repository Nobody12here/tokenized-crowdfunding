...
export async function getServerSideProps({ params }) {
  ...
  const summary = [
    "10000000000000000", // Minimum contribution (0.01 ETH in WEI)
    "2000000000000000000", // Balance (2 ETH in WEI)
    10, // Requests count
    50, // Approvers count
    "0x1234567890abcdef1234567890abcdef12345678", // Manager address
    "Save the Ocean", // Campaign name
    "Help us clean and restore the oceans through community-driven initiatives.", // Description
    "https://via.placeholder.com/600", // Image URL
    "5000000000000000000", // Target amount (5 ETH in WEI)
  ];
